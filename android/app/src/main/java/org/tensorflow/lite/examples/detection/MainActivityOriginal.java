...
public class MainActivityOriginal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraButton.setOnClickListener(v -> startActivity(new Intent(MainActivityOriginal.this, DetectorActivity.class)));
        ...
        this.sourceBitmap = Utils.getBitmapFromAsset(MainActivityOriginal.this, "kite.jpg");
